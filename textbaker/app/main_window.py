...
from PySide6.QtWidgets import (
    ...
    QFileDialog, QGraphicsScene, QDialog, QSlider, QGroupBox,
    QTextBrowser, QLineEdit, QDockWidget, QScrollArea,
    QRadioButton, QButtonGroup, QMessageBox
)
from PySide6.QtCore import Qt, QTimer, QRectF
from PySide6.QtGui import QPixmap, QImage, QPainter

from textbaker.widgets.dialogs import TexturePickerDialog, HintsDialog
from textbaker.widgets.graphics import ResizableRotatableTextItem, InteractiveGraphicsView
...
class DatasetMaker(QMainWindow):
    ...
    def _init_right_dock(self):
        ...
        # RGB controls
        for color, (default_min, default_max) in [("R", (100, 255)), ("G", (100, 255)), ("B", (100, 255))]:
    ...
    def _generate_random_text(self) -> str:
        ...
        if not char_pool:
            char_pool = ''.join([
                char for char, cb in self.character_checkboxes.items() 
    ...
    def _apply_text_perspective(self):
        ...
        if self.text_item and self.current_composite is not None:
            transformed = self.image_processor.apply_perspective_to_image(self.current_composite, angle)
    ...
    def scan_dataset(self):
        """Scan dataset folder for character images."""
            ...
            for char in custom_text:
                ...
                if char_img is not None:
                    aug = self.image_processor.crop_resize_pad_char(
                        ...
                        perspective_range=(self.min_perspective.value(), self.max_perspective.value()),
